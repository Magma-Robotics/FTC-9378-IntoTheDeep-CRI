...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -705.8557432841106; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2066.0090773579195; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1983.8342724887243; // x position of the perpendicular encoder (in tick units)
    }
