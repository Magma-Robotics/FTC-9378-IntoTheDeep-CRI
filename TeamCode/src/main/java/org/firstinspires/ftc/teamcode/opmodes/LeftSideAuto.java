        ...
        SilkRoad.RunAsync(
                new SequentialAction(
                        ...
                        new ParallelAction(
                            ...
                            new ParallelAction(
                                new SleepAction(2.2),
                                new MercurialAction(GroupedCommands.INSTANCE.setHighScoringCommand())
                            )
                        ),
                        //score sample
                        score,
                        ...
                        new ParallelAction(
                                ...
                                new SequentialAction(
                                        new SleepAction(0.1),
                                        new MercurialAction(GroupedCommands.INSTANCE.setCloseIntakeCommand())
                                ),
                                new SequentialAction(
                                        new SleepAction(0.5),
                                        moveToMiddle
                        ...
                        new MercurialAction(Intake.INSTANCE.setClawOpen(false)),
                        new SleepAction(0.3),
                        new MercurialAction(GroupedCommands.INSTANCE.intakeToHomeCommand()),
                        //move to basket
                        new ParallelAction(
                                score2,
                                new ParallelAction(
